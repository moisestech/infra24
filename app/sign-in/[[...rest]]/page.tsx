    ...
    <div className="relative z-20 flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="mb-2 text-4xl font-bold text-white">Smart Sign</h1>
        ...
        <SignIn
          ...
          appearance={{
            ...
            elements: {
              ...
              formButtonPrimary:
                'w-full bg-blue-600 text-white hover:bg-blue-700 font-semibold py-3 px-4 rounded-md transition-all duration-300',
              formFieldInput:
                'w-full bg-gray-900 border border-gray-700 text-white placeholder-gray-500 py-3 px-4 rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all duration-300',
              ...
              socialButtonsBlockButton:
                'w-full flex items-center justify-center gap-3 bg-gray-900 border border-gray-700 hover:border-blue-500 text-white py-3 px-4 rounded-md transition-all duration-300 text-sm',
              ...
              formButtonSecondary:
                'w-full bg-gray-900 border border-gray-700 text-white hover:border-blue-500 py-3 px-4 rounded-md transition-all duration-300',
