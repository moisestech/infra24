...
import { FabricateStartForm } from '@/components/dcc/fabrication/FabricateStartForm'
import {
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `Start a project | ${dccSiteMeta.organizationName}`,
    url: '/fabricate/start',
  },
}

export default function FabricateStartPage() {
  return (
    <FabricateChrome current="start">
      <header className="mb-8 grid min-w-0 gap-6 md:mb-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
        <div className="min-w-0 max-w-2xl">
          ...
          <p className="mt-3 text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 md:text-base">
            Tell us what you have and what you need to learn. Staff review every inquiry —
            a service is suggested, not assigned, until a human looks at it.
          </p>
