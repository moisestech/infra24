...
export const metadata: Metadata = {
  title: 'Beginner Cheat Sheet — Print',
  alternates: { canonical: '/workshop/saturday-lab/print/beginner' },
}

export default function PrintBeginnerGraphicPage() {
  const src = SATURDAY_LAB_CHEAT_SHEET_IMAGES.beginner
  ...
  return (
    <SaturdayLabShell currentPath="/workshop/saturday-lab/print">
      <div className="space-y-4 print:space-y-0">
        ...
        <Image
          src={src}
          alt="Artist Website for Beginners cheat sheet"
          width={1200}
          height={1600}
