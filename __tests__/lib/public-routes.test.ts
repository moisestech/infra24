...
describe('isPublicRoute', () => {
  ...
  it('keeps DCC fabricate pages public, including the /fabrication alias', () => {
    ...
    expect(isPublicRoute('/api/dcc/fabricate/proposals/unlock')).toBe(true)
    expect(isPublicRoute('/api/dcc/fabricate/start')).toBe(true)
    expect(isPublicRoute('/api/dcc/fabricate/media/heather-deitch/hero.png')).toBe(true)
