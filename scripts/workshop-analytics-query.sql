...
-- =====================================================
-- Comprehensive workshop analytics for production database
-- Shows all workshops with their status, Learn Canvas info, and chapter details

-- 1. WORKSHOP OVERVIEW WITH LEARN CANVAS STATUS
