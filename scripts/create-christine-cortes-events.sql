-- Create Christine Cortes Events Script
...
-- This will help us identify the correct author_clerk_id to use

-- Check all users in Bakehouse organization
SELECT 
...
-- If no users are found, you'll need to create a user first or use an existing user ID
-- For now, let's use a placeholder that you can replace with an actual user ID
-- Replace 'REPLACE_WITH_ACTUAL_USER_ID' with a real clerk_user_id from the query above

-- Alternative approach: Use a variable to store the user ID
-- Uncomment and modify the line below with an actual user ID:
-- \set author_user_id 'user_2abc123def456ghi'

-- Or use this query to get the first available user:
-- SELECT clerk_user_id FROM org_memberships om 
-- JOIN organizations o ON om.org_id = o.id 
-- WHERE o.slug = 'bakehouse' 
...
-- September 8th, 2024 (12:30-2:30pm)
INSERT INTO announcements (
    ...
    'REPLACE_WITH_ACTUAL_USER_ID', -- Replace with actual clerk_user_id from the query above
    ...
    '2024-09-08 12:30:00-04:00', -- September 8th, 12:30 PM EST
    '2024-09-08 14:30:00-04:00', -- September 8th, 2:30 PM EST
...
-- 2. OPEN STUDIOS
-- September 9th, 2024 (6:00-9:00pm)
INSERT INTO announcements (
    id,
    org_id,
    author_clerk_id,
    ...
    (SELECT clerk_user_id FROM org_memberships om 
     JOIN organizations o ON om.org_id = o.id 
     WHERE o.slug = 'bakehouse' 
     AND om.role IN ('org_admin', 'moderator') 
     LIMIT 1),
    'OPEN STUDIOS',
    ...
    '2024-09-09 18:00:00-04:00', -- September 9th, 6:00 PM EST
    '2024-09-09 21:00:00-04:00', -- September 9th, 9:00 PM EST
...
INSERT INTO announcements (
    ...
    '2024-09-11 18:00:00-04:00', -- September 11th, 6:00 PM EST
    '2024-09-11 20:00:00-04:00', -- September 11th, 8:00 PM EST
...
INSERT INTO announcements (
    ...
    'administrative',
    'survey',
    '2024-09-22 23:59:00-04:00', -- September 22nd, 11:59 PM EST
...
INSERT INTO announcements (
    ...
    'exhibition',
    'Dimensions Variable',
    '2024-08-24 00:00:00-04:00', -- August 24th
    '2024-10-10 23:59:00-04:00', -- October 10th
...
INSERT INTO announcements (
    ...
    '2024-08-30 00:00:00-04:00', -- August 30th
    '2024-10-05 23:59:00-04:00', -- October 5th
...
INSERT INTO announcements (
    ...
    '2024-09-28 00:00:00-04:00', -- September 28th
    '2025-11-09 23:59:00-05:00', -- November 9th, 2025 (Note: This seems like a typo in the email, should probably be 2024)
