-- Test script to create MadArts organization with correct schema
-- This is a simplified version that matches your actual database schema

-- Enable UUID extension if not already enabled
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Insert MadArts organization with only the columns that exist in your schema
