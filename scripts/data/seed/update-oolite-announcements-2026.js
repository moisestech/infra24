...
const IMAGES = {
  ...
  // May / June 2026 newsletter (Cloudinary)
  beatrizChachamovitsWalgreensJune2026:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268825/june-3_sept-6-2026-beatriz-chachamovits-heliotropic-seekers-drift-windows-walgreens-74th-street-and-collins-ave_xrdyxs.jpg',
  anaMosqueraMiamiBeachLibrary:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268823/ana-mosquera-2025-2026-studio-resident-is-part-of-whats-my-line-drawing-as-experience-presented-by-edge-zones-and-curated-by-alumnus-dimitry-said-on-view-at-the-miami-beach-regional-library-through-july-16_gbmltw.png',
  crossingBridgePanelMay23_2026:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268821/edouard-duval-carrie-and-yanira-collado-moderated-by-lauryn-lawrence-saturday-may-23-2026_srwlwo.png',
  markDelmontWalgreensJune2026:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268819/mark-delmont-for-a-lifetime-windows-walgreens-67th-street-and-collins-ave_c5t7ne.jpg',
  ooliteArtsOnTheMoveMay2026:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268818/oolite-arts-may-community-on-the-move_o9prdz.png',
  skillsPathToPublicArtMay2026:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268815/sustaining-and-propelling-artists-careers-skills-the-path-to-public-art_lc8hur.png',
  crossingBridge924LastWeeksMay2026:
    'https://res.cloudinary.com/dkod1at3i/image/upload/v1778268814/feb-25_may-24-2026-crossing-the-bridge-924-lincoln_Rd._Miami_Beach_Don_t_miss_the_last_weeks_of_Crossing_the_Bridge_curated_by_Claire_Breukel_and_Lauryn_Lawrence_and_featuring_Edouard_Duval-Carrie%CC%81_Kerry-phillips-najja-moon-susan_vjumsk.jpg'
};
...
async function updateOoliteAnnouncements() {
  try {
    ...
    /** May / June 2026 newsletter anchors */
    const may4_2026_noon = new Date('2026-05-04T12:00:00');
    const may7_2026_eve = new Date('2026-05-07T19:00:00');
    const may8_2026_anchor = new Date('2026-05-08T12:00:00');
    const may16_2026_eve = new Date('2026-05-16T17:00:00');
    const may18_2026_noon = new Date('2026-05-18T12:00:00');
    const may23_2026_eve = new Date('2026-05-23T18:00:00');
    const june3_2026_tour = new Date('2026-06-03T18:00:00');
    const june3_2026_exhibit = new Date('2026-06-03T12:00:00');
    const sept6_2026_end = new Date('2026-09-06T23:59:59');
    ...
    const announcements = [
      ...
      },
      {
        ...
        image_layout: 'card',
        people: [
          { name: 'Diego Gabaldon', role: 'Studio 102', avatar_url: placeholderImage(150, 150, 'DG') },
          { name: 'Gonzalo Hernandez', role: 'Studio 204A', avatar_url: placeholderImage(150, 150, 'GH') },
          { name: 'Sepideh Kalani', role: 'Studio 204', avatar_url: placeholderImage(150, 150, 'SK') },
          { name: 'Shayla Marshall', role: 'Studio 209', avatar_url: placeholderImage(150, 150, 'SM') },
          { name: 'Bex McCharen', role: 'Studio 108', avatar_url: placeholderImage(150, 150, 'BM') },
          { name: 'Lucia Morales', role: 'Studio 101', avatar_url: placeholderImage(150, 150, 'LM') },
          { name: 'Genesis Moreno', role: 'Studio 210', avatar_url: placeholderImage(150, 150, 'GM') },
          { name: 'Ana Mosquera', role: 'Studio 202', avatar_url: placeholderImage(150, 150, 'AM') },
          { name: 'Sheherazade Thenard', role: 'Studio 208', avatar_url: placeholderImage(150, 150, 'ST') },
          { name: 'Pangea Kali Virga', role: 'Studio 203', avatar_url: placeholderImage(150, 150, 'PKV') },
          { name: 'Nadia Wolff', role: 'Studio 110', avatar_url: placeholderImage(150, 150, 'NW') },
          { name: 'Ricardo E. Zulueta', role: 'Studio 109', avatar_url: placeholderImage(150, 150, 'REZ') },
          { name: 'José Delgado Zúñiga', role: 'Studio 207', avatar_url: placeholderImage(150, 150, 'JDZ') }
        ],
        published_at: now.toISOString()
      },
      {
      ...
      },
      {
        ...
        image_url: IMAGES.crossingBridge924LastWeeksMay2026,
        image_layout: 'card',
        rsvp_label: 'RSVP',
        rsvp_url: '#', // Will be updated with actual RSVP link
        people: [
      ...
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'The Ellies, Oolite Arts Awards — April 22 Recap',
        body: 'On April 22, we gathered for The Ellies, Oolite Arts Awards to celebrate the artists and art leaders who shape South Florida\'s cultural community. As South Florida\'s premier art award program, The Ellies distributed $425,000 in direct financial support this year, with additional funds through acquisitions—continuing its commitment to investing in artists across the region.\n\nThe night honored Mario Cader-Frech and Robert S. Wennett, and recognized Honorary Chairs Jorge M. Pérez and Darlene Pérez and Co-Chairs Sergio García Granados and Tanya Brillembourg.\n\nWe celebrated 38 artists across four award categories; introduced the Ellies Awards Artist Host Committee, led by accomplished Oolite Arts alumni; and presented the inaugural Oolite Arts Auction.\n\nPhoto credits: Logan Fazio and World Red Eye',
        status: 'published',
        priority: 'high',
        tags: ['ellies', 'awards', 'recap', 'april-2026'],
        visibility: 'public',
        type: 'news',
        sub_type: 'general',
      ...
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Weekly Curatorial Tours — Crossing the Bridge (May 2026)',
        body: 'Join us for weekly tours of Crossing the Bridge, led by co-curator Lauryn Lawrence, which offer visitors an intimate look into this collaborative exhibition.\n\nUpcoming dates:\nMay 4, 12 - 1 p.m.\nMay 18, 12 - 1 p.m.',
        status: 'published',
        priority: 'normal',
        tags: ['tours', 'curatorial', 'crossing-the-bridge', 'may-2026'],
        visibility: 'public',
        type: 'event',
        sub_type: 'general',
        starts_at: may4_2026_noon.toISOString(),
        ends_at: may18_2026_noon.toISOString(),
        location: '924 Lincoln Rd., Miami Beach',
      ...
      },
      {
        ...
        body: 'Panel Discussion with Edouard Duval-Carrié and Yanira Collado, moderated by Lauryn Lawrence.\n\nSaturday, May 23, 2026\n6 - 8 p.m.',
        status: 'published',
        priority: 'normal',
        tags: ['panel', 'crossing-the-bridge', 'may-2026'],
        visibility: 'public',
        type: 'event',
        sub_type: 'meeting',
        starts_at: may23_2026_eve.toISOString(),
        location: '924 Lincoln Rd., Miami Beach',
        image_url: IMAGES.crossingBridgePanelMay23_2026,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org',
        published_at: now.toISOString()
      },
      {
        ...
        body: 'Oolite Arts Conversations: Inaugural Season Starts May 7\n\nIntroducing Oolite Arts Conversations — a new public series bringing leading artists, curators, and cultural thinkers into dialogue around today\'s most pressing ideas in contemporary art.\n\nDesigned as a space for exchange rather than lecture, the series connects global perspectives with Miami\'s evolving cultural landscape.',
        status: 'published',
        priority: 'normal',
        tags: ['conversations', 'public-series', 'may-2026'],
        visibility: 'public',
        type: 'news',
        sub_type: 'general',
        starts_at: may7_2026_eve.toISOString(),
      ...
      },
      {
        ...
        body: 'Sustaining and Propelling Artists\' Careers\n\nSkills: The Path to Public Art\n\nJoin Ellies Creator Award winner Carola Bravo for a two-hour introductory workshop that provides artists with a practical roadmap to the basics of applying to public art calls.\n\nThursday, May 21, 2026\n6 - 8 p.m.',
        status: 'published',
        priority: 'normal',
        ...
        image_url: IMAGES.skillsPathToPublicArtMay2026,
        image_layout: 'card',
      ...
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Antoni Miralda in Conversation with César E. Trasobares and Stephan Palmié',
        body: 'Part of Oolite Arts Conversations.\n\nThursday, May 7, 2026\n7 - 9 p.m.\n\nProscenium Theatre\nLittle Haiti Cultural Complex\n212 NE 59th Terrace',
        status: 'published',
        priority: 'normal',
        tags: ['conversations', 'panel', 'may-2026'],
        visibility: 'public',
        type: 'event',
        sub_type: 'meeting',
        starts_at: may7_2026_eve.toISOString(),
        location: 'Little Haiti Cultural Complex, 212 NE 59th Terrace, Miami',
        image_url: IMAGES.ooliteConversations,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org',
        published_at: now.toISOString()
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Oolite Arts On the Move: Haitian Heritage Month',
        body: 'Oolite Arts On the Move: A New Community Initiative\n\nJoin us at the Little Haiti Cultural Complex for the launch of Oolite Arts On the Move, bringing free, artist-led programs to neighborhoods across Miami.\n\nCelebrate Haitian Heritage Month with a hands-on art experience led by Haitian artists and Oolite Arts alumni Stephen Arboite and Mark Delmont. Families and community members of all ages will create artwork inspired by Haitian culture and traditions.\n\nSaturday, May 16, 2026\n5 - 7 p.m.\nLittle Haiti Cultural Complex, Art Room\n212 NE 59th Terrace\n\nPhoto credit: Elvis Suarez - Glasswork Multimedia',
        status: 'published',
        priority: 'high',
        tags: ['community', 'little-haiti', 'may-2026'],
        visibility: 'public',
        type: 'event',
        sub_type: 'general',
        starts_at: may16_2026_eve.toISOString(),
        location: 'Little Haiti Cultural Complex, Art Room, 212 NE 59th Terrace, Miami',
        image_url: IMAGES.ooliteArtsOnTheMoveMay2026,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org',
        published_at: now.toISOString()
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Beatriz Chachamovits: Heliotropic Seekers: Drift (Windows @ Walgreens)',
        body: 'Crossing the Bridge Alumni Exhibition\n\nON VIEW JUNE 3–SEPT. 6, 2026\n\nBeatriz Chachamovits: Heliotropic Seekers: Drift\nWindows @ Walgreens\n74th Street and Collins Ave.',
        status: 'published',
        priority: 'normal',
        tags: ['exhibition', 'windows-walgreens', 'june-2026'],
        visibility: 'public',
        type: 'event',
        sub_type: 'exhibition',
        starts_at: june3_2026_exhibit.toISOString(),
        ends_at: sept6_2026_end.toISOString(),
        location: 'Windows @ Walgreens, 74th Street and Collins Ave.',
        image_url: IMAGES.beatrizChachamovitsWalgreensJune2026,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org',
        published_at: now.toISOString()
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Mark Delmont: For a Lifetime (Windows @ Walgreens)',
        ...
        ends_at: sept6_2026_end.toISOString(),
        location: 'Windows @ Walgreens, 67th Street and Collins Ave.',
        image_url: IMAGES.markDelmontWalgreensJune2026,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org',
        published_at: now.toISOString()
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Walgreens Windows Currents: Walking Tour + Opening Reception',
        body: 'Celebrate the opening of Walgreens Windows Currents: Labor, Drift, and Collective Navigation featuring Beatriz Chachamovits and Mark Delmont.\n\nWednesday, June 3, 2026\n\n6 - 7 p.m.: Walking Tour, beginning at 74th and Collins Ave. and ending at 67th and Collins Ave.\n7 - 9 p.m.: Reception at Normans Tavern, 6770 Collins Ave., Miami Beach 33141',
        status: 'published',
        priority: 'high',
        tags: ['tour', 'reception', 'windows-walgreens', 'june-2026'],
        visibility: 'public',
        type: 'event',
        sub_type: 'general',
        starts_at: june3_2026_tour.toISOString(),
        location: 'Walking tour: 74th & Collins Ave. to 67th & Collins Ave.; Reception: Normans Tavern, 6770 Collins Ave., Miami Beach',
        image_url: IMAGES.beatrizChachamovitsWalgreensJune2026,
        image_layout: 'card',
        rsvp_label: 'RSVP Now',
      ...
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'Resident and Alumni News — May 2026',
        body: 'Keep up with our Oolite Arts artists and alumni:\n\nJuana Valdes (2018 Ellies Creator Award winner) was awarded a 2026 Guggenheim Fellowship in Fine Arts.\n\nPangea Kali Virga (current Studio Resident) co-curates Piecework Legacies, on view now through July 2 at the Miami-Dade Public Main Library. The exhibition features work by residents and alumni Bex McCharen, Carrington Ware, Regina Jestrow, and Carrie Sieh.\n\nSusan LeeChun (2005 Studio Resident), currently featured in Crossing the Bridge at Oolite Arts, presents Everybody Suz-ercise!, on view now through June 28 at MDC Padrón Campus Art Gallery.\n\nHansel Porras Garcia (2021 Cinematic Resident and current Cinematic Manager) presented his latest feature film Tropical Park at Museum of the Moving Image on May 3 as part of the 15th edition of the First Look Film Festival.\n\nAna Mosquera (2025-2026 Studio Resident) is part of What\'s My Line? Drawing as Experience, presented by Edge Zones and curated by alumnus Dimitry Saïd, on view at the Miami Beach Regional Library through July 16.',
        status: 'published',
        priority: 'normal',
        tags: ['alumni', 'residents', 'news', 'may-2026'],
        visibility: 'public',
        type: 'news',
        sub_type: 'general',
        starts_at: may8_2026_anchor.toISOString(),
        image_url: IMAGES.anaMosqueraMiamiBeachLibrary,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org',
        published_at: now.toISOString()
      },
      {
        ...
        created_by: 'system_oolite',
        updated_by: 'system_oolite',
        title: 'I Wonder… Clay on a Canvas with The Center for Arts and Innovation (Sold Out)',
        body: 'Our upcoming collaboration with The Center for Arts and Innovation, "I Wonder… What It Would Be Like to Create with Clay on a Canvas," led by artist Karen Starosta-Gilinski, is now sold out, drawing participants from across South Florida.\n\nThis hands-on workshop reflects Oolite Arts\' expanding reach across Miami-Dade, Broward, Palm Beach, and Monroe counties, bringing together a dynamic community engaged in material, process, and creative exploration. The collaboration highlights a shared commitment to creativity as a force for connection, experimentation and discovery.\n\nMore collaborative classes with The Center are on the way.\n\nInterested in partnering with Oolite Arts? We welcome opportunities to work with institutions and organizations to expand access to meaningful arts experiences across South Florida.\n\nFor more information or for partnering opportunities, please contact Community Art Classes Manager Melissa Gabriel at mgabriel@oolitearts.org.\n\nTake art classes at Oolite Arts: https://oolitearts.org/classes',
        status: 'published',
        priority: 'normal',
        tags: ['workshop', 'partnership', 'may-2026'],
        visibility: 'public',
        type: 'news',
        sub_type: 'general',
        starts_at: may8_2026_anchor.toISOString(),
        image_url: IMAGES.campusProgress2,
        image_layout: 'card',
        primary_link: 'https://oolitearts.org/classes',
        published_at: now.toISOString()
      }
    ...
    const archiveTitles = [
      'The Ellies 2026',
      'The Ellies 2026: Tickets Available',
      'Weekly Curatorial Tours (April 2026)',
