...
| 3D-MAP-001 | 3D modeling mental models (HTML map remains primary) | 16:9 | 3D School | Cloudinary wired |
| 3D-PIPELINE-001 | Digital-to-physical pipeline | 21:9 | 3D School + Foundation | Cloudinary wired |
| 3D-FOUNDATION-HERO-001 | From File to Physical Object hero | 16:9 | Foundation | Cloudinary wired |
| 3D-FOUNDATION-FORMATS-001 | STL / OBJ / STEP / 3MF comparison | 4:3 | Foundation | Cloudinary wired |
| 3D-FOUNDATION-PRINTABILITY-001 | Printability problems | 4:3 | Foundation | Cloudinary wired |
...
| 3D-PLASTICITY-STUDIO-OBJECTS-001 | Studio object set | 21:9 | Plasticity | Cloudinary wired |
| 3D-PLASTICITY-BRIDGE-001 | Plasticity → Blender → slicer → print | 16:9 | Plasticity | TODO (candidate is 21:9 — do not wire) |
| 3D-RHINO-HERO-001 | Rhino for Artists hero | 16:9 | Rhino | Cloudinary wired |
| 3D-RHINO-JEWELRY-001 | Precision wearable | 4:3 | Rhino | TODO (candidate is 16:9 — do not wire) |
...
| 3D-SCHOOL-OVERALL-LANDSCAPE-001 | Overall 3D School landscape | 16:9 | 3D School | Cloudinary wired |
...
- **3D-SCHOOL-OVERALL-LANDSCAPE-001** — Editorial studio landscape of mesh, solid, and surface forms. Not a /workshops hero-strip tile.
