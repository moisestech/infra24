...
const unsortedAnnouncements: Announcement[] = [
  {
    ...
    subType: "social",
    template: "pattern",
    title: "Pizza Lunch with Villa Albertine Fellows",
    date: "March 12, 2025",
    time: "1:00 PM - 2:00 PM",
    location: "Atrium (outside office)",
    description:
      "Join us for a casual pizza lunch and conversation with artist fellows Alison Benezech, Bouziane Bouteldja, and Mathilde Rispal from the Villa Albertine program. RSVP by March 12, 10 AM.",
    visibility: "internal",
    expires_at: "2025-03-12",
    organizations: [{ name: "Villa Albertine" }],
  },
  {
    id: "admin-document-001",
    type: "administrative",
    subType: "document",
    template: "pattern",
    title: "Updated Digital Print Lab Info",
    date: "March 11, 2025",
    description:
      "New guidelines, available papers list, and Q&A section are now available. Contact Christine Cortes at christinecortesphotography@gmail.com for inquiries.",
    visibility: "internal",
    expires_at: "2025-12-31",
    key_people: [{ name: "Christine Cortes", role: "Digital Print Lab Manager" }],
  },
  {
    id: "admin-deadline-002",
    type: "administrative",
    subType: "deadline",
    template: "pattern",
    title: "Residency Agreements Due",
    date: "March 31, 2025",
    description:
      "Studio residents must digitally sign orientation documents and residency agreements by March 31, 2025. Schedule your appointment with Krys at kortega@bacfl.org.",
    visibility: "internal",
    expires_at: "2025-03-31",
    key_people: [{ name: "Krys Ortega", role: "Residency Coordinator" }],
  },
  {
    id: "opportunity-commission-003",
    type: "opportunity",
    subType: "commission",
    template: "pattern",
    title: "Public Art Commission at FLL Airport",
    date: "March 30, 2025",
    description:
      "Artists sought to create visually engaging artwork for Terminal Connectors at Fort Lauderdale-Hollywood International Airport. Apply by March 30, 2025.",
    primary_link: "https://example.com/fll-airport-commission-details",
    visibility: "both",
    expires_at: "2025-03-30",
    organizations: [
      { name: "Broward Cultural Council Public Art & Design Program" },
      { name: "Broward County Aviation Department" },
    ],
  },
  {
    id: "facility-storage-004",
    type: "facility",
    subType: "storage",
    template: "pattern",
    title: "Spray Room Reopening & Storage Move",
    date: "April 4, 2025",
    description:
      "The spray room will reopen for artists by April 4. Remove personal items from the current spray room before this date; leftover items will be disposed.",
    visibility: "internal",
    expires_at: "2025-04-04",
    key_people: [{ name: "Phil Lique", role: "Chief Technology Strategist" }],
  },
  {
    id: "event-openstudios-005",
    type: "event",
    subType: "open_studios",
    template: "pattern",
    title: "Toledo Museum of Art Studio Visit",
    date: "April 1, 2025",
    time: "3:30 PM - 4:30 PM",
    location: "Bakehouse Art Complex",
    description:
      "A group of 40 visitors from the Toledo Museum of Art, including the museum director, will visit studios. Sign up to have your studio included on the visitor map.",
    primary_link: "https://example.com/toledo-museum-visit-signup",
    visibility: "internal",
    expires_at: "2025-04-01",
    key_people: [{ name: "Cathy Leff", role: "Executive Director" }],
    organizations: [{ name: "Toledo Museum of Art" }],
  },
  {
    id: "facility-maintenance-006",
    type: "facility",
    subType: "maintenance",
    template: "pattern",
    title: "Electrical Updates & Outages",
    date: "March 17, 2025",
    description:
      "Bakehouse will have electrical upgrades in the coming weeks, including minor construction and potential brief outages. We'll provide updates on exact times.",
    visibility: "internal",
    expires_at: "2025-05-01",
    key_people: [{ name: "Phil Lique", role: "Chief Technology Strategist" }],
  },
  {
    id: "event-workshop-007",
    type: "event",
    subType: "workshop",
    template: "pattern",
    title: "CNC Machine Onboarding Session",
    date: "March 29, 2025",
    time: "10:00 AM - 4:00 PM",
    location: "BAC Woodshop",
    description:
      "Mandatory 6-hour onboarding session for the new CNC Machine. Sign up by March 21 for access to future CNC use.",
    primary_link: "https://example.com/cnc-onboarding-signup",
    visibility: "internal",
    expires_at: "2025-03-29",
    key_people: [{ name: "Christopher Carter", role: "BAC Board Member" }],
  },
