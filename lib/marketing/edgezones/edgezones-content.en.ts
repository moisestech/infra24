...
export const edgeZonesPortalEn: EdgeZonesPortalContent = {
  slug: 'edgezones',
  path: '/edgezones',
  creditLine:
...
The exhibition brings together artists whose practices examine how digital technologies shape attention, labor, memory, ecology, and social life — and how those systems loop back into our bodies, relationships, and environments.`,
    statusChips: ['Host Space', 'Curator', 'Digital Platform'],
  },
  primaryCtas: [
  ...
  concept: {
    ...
    paragraphStages: [
      {
        label: 'Step outside the screen',
        caption: 'Slowness · care · texture · lived experience',
      },
      {
        label: 'Systems meet bodies',
        caption: 'Perception · land · shared social life',
      },
    ],
    themes: [
      {
  ...
  ui: {
    ...
    programsBannerCaption: 'DCC-supported public program',
    archiveBannerCaption: 'Documentation archive',
    hostSpaceBadge: 'Host Space',
    invitedCuratorBadge: 'Invited Curator',
    participatingArtistBadge: 'Participating Artist',
    participatingArtistBadgeShort: 'Artist',
    workImageComingSoon: 'Work image coming soon',
    artistMaterialsPending: 'Artist materials pending',
    openResearchMap: 'Open research map →',
    materialsNeededPrefix: 'Materials needed:',
    partnershipContactTitle: 'Partnership contact',
    partnershipContactBody:
      'Questions about Edge Zones programming or the Touching Grass exhibition? Reach Charo Oquet (Edge Zones) via the DCC team.',
    emailDccTeam: 'Email the DCC team',
    downloadPartnershipPdf: 'Download Partnership PDF',
    openPdfNewTab: 'Open PDF in New Tab',
    bookletDescription:
      'The full proposal packet outlines the partnership framework, exhibition concept, DCC support model, artist cluster, and network index — formatted as a printable booklet.',
    bookletLabel: 'Partnership proposal packet',
    bookletAriaLabel: 'Open DCC Miami × Edge Zones partnership PDF',
    instagram: 'Instagram',
    website: 'Website',
    jumpTo: 'Jump to',
  },
