...
export function CtaBlock({
  ...
  return (
    <div
      className={cn(
        'rounded-lg border border-neutral-200 bg-neutral-50 px-6 py-8 sm:px-8 sm:py-10',
        className
      )}
    >
      ...
      {body && <p className="mt-2 max-w-2xl text-sm leading-relaxed text-neutral-600">{body}</p>}
