...
import { SATURDAY_LAB_CHEAT_SHEET_IMAGES, type SaturdayLabIconKey } from '@/lib/workshops/saturday-lab-media'
          ...
          >
            <div className="mb-2 flex items-center gap-2">
              <span className="flex h-9 w-9 items-center justify-center rounded-full bg-neutral-100">
                <SaturdayLabIcon icon={path.icon} label={path.title} size={20} />
              </span>
              <div>
